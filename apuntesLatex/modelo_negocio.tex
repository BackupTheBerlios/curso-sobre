...
A continuación vamos a comentar con más en detalle cada uno de los tipos.
...
Otro modelo de financiación es crear proyectos competitivos, con planes avanza,
que se evaluan según lo que pueden ofrecer a la investigación. Éstos pueden
ser software libre. 
...
Las motivaciones para la financiación de este tipos de proyectos son variadas,
...
La forma de financiar los proyectos es muy parecida al que se usa en las
empresas públicas.


\subsection{Porque alguien necesita mejoras}
En este caso si existe el ánimo de lucro. El proyecto en cuestión se financia
...
Uno de los casos es \emph{Corel}, quería portar todo su software a Linux para
...
Y el software libre es el instrumento para hacerlo. Intentar obtener centimos
...
Google es esta. Ring están creando WebOS con software libre pero es privativo.
...
que la distribución sea conocida y mucha gente lo utilice.
\end{itemize}
...
puede hacer que depués cuando haya que realizar un cambio pueda ofrecer precios
...
Este modelo intenta limitar el problema que teniamos anteriormente de que la
...
El problema que tiene esto es que las comunidades, puedes crear las partes
...
Finalmente la financiación se termina rentabilizando en terminos de imagen de
marca.
...
invertido para crear Evolution. Mucha gente les conocia y estaban en una buena
...
gestión de centralitas para su uso en VozIP.
\end{itemize}
...
Otra forma de poner limitaciones a la competencia es primero puedo hacer el
producto privativo y cuando me interese lo libero, de esta manera la competencia
irá retrasada con respecto a mi. 
...
Es una variantes del apartado anterior, lo único es que lo hago a la vez.
...
derivada, tendrá que añadir está licencia.

Según el modelo de negocio dependerá mucho de las licencias que uses.

\subsection{Venta de marca}
Lo único que quiero es verder marca, del estilo de Red-Hat. Vende servicios
...
en su tiempo libre o bien ciertas horas al días.

Aunque no están financiados si reciben alguna contribución, como parches por
...
Este tipo de financiación está basada en yo necesito algo y la desarrollo como
software libre, de esta manera al publicarse el código estará más limpio y en un
fúturo puedo encontrar colaboración.
